...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['trader', 'portfolio-manager', 'financial-analyst', 'risk-manager', 'administrator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Trade', path: '/trades', entity: 'trade', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
